...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/vfile-reader
   cd vfile-reader
   ```
...
```sh
https://github.com/flex-development/vfile-reader/compare/main...$branch
```
...
[discussion-qa]: https://github.com/flex-development/vfile-reader/discussions/new?category=q-a
